...
class TaskListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user1 = self.User.objects.create_user(
            username="testuser1", email="user@gmail.com", password="password123"
        )
        self.user2 = self.User.objects.create_user(
            username="testuser2", email="user2@gmail.com", password="password123"
        )
...
class AssignTaskViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.creator_user = self.User.objects.create_user(
            username="taskcreate", email="creator@gmail.com", password="password123"
        )
        self.assign_user = self.User.objects.create_user(
            username="taskassign", email="assign@gmail.com", password="password123"
        )
